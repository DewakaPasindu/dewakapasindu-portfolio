...
import ranabima from "../images/thurstanofficial_logo.jpg";
...
export const Bio = {
  ...
  resume:"https://dochub.com/dewaka-pasindu/nO1YzvAwA3zepJkK6L4WP2/dewaka-pasindu-l-cv-resume-pdf",
  linkedin: "www.linkedin.com/in/dewaka-pasindu-8b147833a",
  insta: "",
  facebook: "",
};
...
export const education = [
  ...
  },
  {
    id: 1,
    img: ranabima,
    school: "Thurstan College, Colombo 03",
    date: "Feb 2010 - Aug 2018",
    grade: "O/L - 7 A's  | A/L - 3 C's",
    desc: "I completed my high School education at Thurstan College, where I studied Combined Mathematics.",
...
export const projects = [
  {
    ...
    description:
      "Let's Grow, a smart and user-friendly platform for investors and Startups. Our goal is help to find the stratups and new ideas for the investors, while also giving proper proposal to investors, and reach two parties in one platform. within their interested feilds first.",
    image:LetsGrow,    
    tags: [
      "React Js",
      "HTML",
...

  {
    ...
    description:
      "SkillSwap is a web-based full stack platform designed to connect individuals who want to share and exchange skills. The platform offers a rich set of features including, Skill-Based Matching, Interactive Learning Modules, Gamified Experience, Modern UI/UX for users.",
    image:SkillSwap,
    tags: [
      "Node Js",
      "React Js",
    ...
    category: "web app",
    github: "https://github.com/DewakaPasindu/SkillSwap",
    // webapp: "https://podstream.netlify.app/",
    
    // member: [
    //   {
    //     name: "Dewaka Pasindu",
    //     img: `https://github.com/DewakaPasindu.png`,
